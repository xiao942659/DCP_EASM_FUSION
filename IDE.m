...
function res = IDE(sourcePic, Graymean)
%sourcePic=double(imread('./test_images/realworld_5.png'))/256;
[m, n, o]=size(sourcePic);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%initialization
p1=-0.397;p2=0.07774;Patch_size_GWA=75;T=0.02;%T can be adjusted to 0.01~0.05.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%airlight estimation
...
save('E:/SUES/scholar/code/DCP/ide_out/t_refine.mat', 't_refine');
save('E:/SUES/scholar/code/DCP/ide_out/J_IDE.mat', 'J');
res = string("IDE process done!");
%figure,
